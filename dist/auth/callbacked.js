...
function authCallbackHandler(res, req, url) {
    return __awaiter(this, void 0, void 0, function () {
        var key_str;
        return __generator(this, function (_a) {
            key_str = process.env.GITHUB_TOKEN;
            fetch("https://api.github.com/users/nknighta", {
                headers: {
                    Authorization: "Bearer ".concat(key_str),
